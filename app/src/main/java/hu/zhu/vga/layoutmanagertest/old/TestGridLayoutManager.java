 ...
 */
public class TestGridLayoutManager extends RecyclerView.LayoutManager {

    public static final String TAG = "TestGridLayoutManager";
     ...
     */
    public TestGridLayoutManager(Context context) {
     ...
     */
    public TestGridLayoutManager(Context context, int orientation, boolean reverseLayout) {
     ...
     */
    public TestGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
        ...
        LinearSmoothScroller linearSmoothScroller =
                new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    public PointF computeScrollVectorForPosition(int targetPosition) {
                        return TestGridLayoutManager.this
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ScrollbarHelper.computeScrollOffset(state,
                mOrientationHelper,
    ...
    static class LayoutState {
        ...
        final static String TAG = "TestGLM#LayoutState";
